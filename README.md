...
1. Read `specs/SPEC-000.md` to understand policy authority.
2. Read `specs/SPEC-001.md` before defining any action.
3. Read `specs/SPEC-002.md` before classifying risk.
4. Read `specs/SPEC-003.md` before requesting approval.
5. Read `specs/SPEC-004.md` before trusting any conclusion.
6. Read `docs/ARCHITECTURE.md` before integrating another repository.
7. Read `docs/TRUST-BOUNDARY.md` before crossing from observation into action.
